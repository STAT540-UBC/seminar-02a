...
If you've been following along so far, and have a successfully knitted Rmd and GitHub Markdown file, you've completed the deliverable. Just make sure to commit & push the required files before the deadline so your assignment can be marked! 
...
This seminar was developed by [Eric Chu](https://github.com/echu113) with materials adapted from [Happy Git and GitHub for the useR](http://happygitwithr.com/) by [Dr. Jenny Bryan](https://github.com/jennybc) and [The Official Documentation on R Markdown](http://rmarkdown.rstudio.com/). It was modified by Keegan Korthauer.
